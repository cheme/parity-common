...
mod tests {
	...
	use super::{keccak, write_keccak, keccak_buffer, KECCAK_EMPTY, H256};

	#[test]
	fn keccak_empty() {
		assert_eq!(keccak([0u8; 0]), H256::from(KECCAK_EMPTY));
	}

	#[test]
	fn keccak_as() {
		assert_eq!(format!("{:x}", keccak([0x41u8; 32])), "59cad5948673622c1d64e2322488bf01619f7ff45789741b15a9f782ce9290a8");
	}
